    ...
    <div class="form-panel">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="text" id="reg-fname" placeholder="Sara"/>
        </div>
        <div class="form-group">
          <label for="reg-lname">Last name</label>
          <input type="text" id="reg-lname" placeholder="Amara"/>
        </div>
      </div>
      <div class="form-group">
        <label for="reg-email">Email</label>
        <input type="email" id="reg-email" placeholder="sara@exemple.com"/>
      </div>
      <div class="form-row">
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="password" id="reg-cpw" placeholder="••••••••"/>
        </div>
      </div>
      ...
      <button class="btn-submit">Create my account</button>
  ...
  <div class="auth-card" id="login">
    ...
    <div class="form-panel">
      ...
      <div class="form-group">
        ...
        <input type="email" id="login-email" placeholder="email@exemple.com"/>
      </div>
      <div class="form-group">
      ...
      <button class="btn-submit">Sign in to Finzo</button>
      <div class="form-footer">
